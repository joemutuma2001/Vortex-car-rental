...
<head>
  <meta charset="utf-8">
  <title>Vortex Car Rental System</title>
      ...
      <section id="services">
        <div class="container">
          <div class="section-header">
            <h2>IDENTIFY YOUR BEST CAR</h2>
            <p>Save money on rental cars by searching for car rental deals on Vortex</p>
          </div>
    ...
    <!--==========================
      ...
      <section id="clients" class="wow fadeInUp">
        <div class="container">
          <div class="section-header">
            <h2>Clients</h2>
            <p>Here is a list of some of the clients we have served. Because of the nature of what we do, many of our other clients naturally choose to maintain their anonymity and guard the competitive edge we have given them.</p>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9 text-center text-lg-left">
              <h3 class="cta-title">Want Our Service?</h3>
              <p class="cta-text">If you have any questions,concerns or issues,we're here to help.Click here to get in touch with us if you need to.</p>
            </div>
